---
title: "Intro to Computational Semiotics Series"
date: 2026-01-09
---

My friend Brandon from Calcifer Computing ([@calco_io](https://x.com/calco_io) on X) is giving an _**Introduction to Computational Semiotics**_ lecture series at Johns Hopkins this Intersession, and I’m learning along with his students as I watch the [lectures he’s shared online](https://drive.google.com/file/d/1dBPNjA0Kes6vX4U2YKHJLv83iU8V-k0L/view).
...
![Definitions of "computational semiotics" and "sign."](https://substackcdn.com/image/fetch/,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb01c966c-740e-45be-a704-40709c7464f6_1174x660.png "Definitions of \"computational semiotics\" and \"sign.\"")
...
_Note: if you feel lost as you read this article, I recommend you [jump to the lecture itself](https://drive.google.com/file/d/1dBPNjA0Kes6vX4U2YKHJLv83iU8V-k0L/view), because Brandon does a great job packing a lot into it in an accessible way._
...
![](https://substackcdn.com/image/fetch/,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F08b7f6bf-1336-400a-b43a-5a8e34cfc595_1008x566.png)
...
![](https://substackcdn.com/image/fetch/,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0d7ccc28-9ae3-4bf6-8245-ec3a76f94c0d_1008x565.png)

He also brings in _**Chain of Thought Steganography**_, which is relevant to AI Alignment Research. This happens when a model is essentially able to encode meaning in the words in its Chain of Thought to make it appear as if it’s not thinking about something it has been penalized for in the past, even though it is.
...
![](https://substackcdn.com/image/fetch/,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fccf9f57d-820a-40a2-9663-77c5040272a9_1172x660.png)
...
1. Functional focuses on the language process itself.
    
2. Structural focuses on the terrain through which language flows.
    
3. Macro focuses on language produced by ensembles.
    
4. Micro focuses on language produced by discrete individuals.
    

You can see the matrix with some tools for studying language here:

![](https://substackcdn.com/image/fetch/,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F59ed58c5-ac66-4aa4-bbaa-17f45bd77f3d_1176x658.png)
...
I’ll be spending some time with these concepts throughout Inkuary and during long train rides as I travel. I plan to continue sharing my quick thoughts or research into CompSemi here and there, both via this substack and [X](https://www.x.com/thrialectics).

There was much more covered that I couldn’t include in this overview, so again, I recommend you also [check the lecture out](https://drive.google.com/file/d/1dBPNjA0Kes6vX4U2YKHJLv83iU8V-k0L/view) yourself.
