---
title: "Project Premortem: Analytical Frameworks Series"
date: 2026-01-12
---

> _“You’re gazing into a crystal ball that can show you the future of your most cherished project. Bad news: it’s an abject failure.”_

![](https://substackcdn.com/image/fetch/,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0e74e97c-bb8e-47a9-a6dc-b5597637fa11_635x300.jpeg)

Dear Friends,

For inkuary, I’m writing through two series: one on [Analytical Frameworks and Tools](https://byemarianne.substack.com/p/inkuary-series-analytical-frameworks), and the other an [Intro to Computational Semiotics](https://byemarianne.substack.com/p/intro-to-computational-semiotics).

This post is the first part of the former, and this first “framework” is more like a structured exercise:

#### The Project Premortem

Some variation of the above “crystal ball scenario” is how the premortem begins. A facilitator, usually the project lead, asks participants to imagine that they have magically received advanced knowledge that their project is a failure — totally, and with absolute certainty.
...
First I’ll explain how it works, then a few reasons why it works. I’ll also draw some connections to my own projects and creative community.

---

#### Five Steps for a Project Premortem

1. The facilitator gives the team a project briefing, ensuring everyone is at the same level of familiarity with the proposed plan.
    
2. Introducing the “crystal ball” scenario, he asks the team to imagine that they have foreknowledge that the plan has completely failed.
    
3. The participants take 3-5 minutes to silently, independently generate reasons for the failure — especially reasons they would ordinarily be hesitant to bring up.
    
4. Round-robin and one at a time, participants share the reasons they came up with. The facilitator should go first, to model the necessary candor.
...
I’m seeing three major factors that make the premortem work:

1. Prospective hindsight, which activates experiential knowledge/world modeling.
    
2. Social permission, which comes from the exercise structure + the facilitator modeling the desired candor.
    
3. Collective intelligence aggregation, which results in risk assessment greater than any one individual could produce on their own.
    

I’d like to stress this third factor — collective intelligence.

Many of you, like me, are currently working on independent creative projects. I’ve never done a premortem, but based on my research, I don’t think it could be too effective as a one-man exercise.

So I’ll close by highlighting the opportunity: we solo artists/creators/builders could form communities of critique around techniques like this, where we provide mutual benefit by participating in e.g. premortems for each others’ projects.

If you’re interested, I’ve got protected time each week for group work/online community, and I’d quite like to test this one with others.

Ideally this will surface more opportunities for us to work together, too, because:

![](https://substackcdn.com/image/fetch/,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff653bdc4-1048-4de9-8d55-d1ec199526aa_1182x574.png)
